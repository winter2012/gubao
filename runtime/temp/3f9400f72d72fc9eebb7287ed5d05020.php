<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:38:"C:\phpStudy\WWW\thinkphp\tpl\close.tpl";i:1528276300;}*/ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <h1 id="logo">
            <img  src="/Public/images/weihu.jpg" />
        </h1>
        <h2>
            <img src="/Public/images/err404.gif" alt='网站维护'/> <?php echo(strip_tags($msg));?>
        </h2>
        <div>
