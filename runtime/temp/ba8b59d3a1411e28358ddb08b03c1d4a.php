<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:28:"public/Simple/orderlist.html";i:1541496839;s:23:"public/Simple/left.html";i:1544507445;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
											...
											<th class="table-type">充值方式</th>
                                            <th class="table-author am-hide-sm-only">充值金额</th>
									...
									<?php if(is_array($g) || $g instanceof \think\Collection): $i = 0; $__LIST__ = $g;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$k): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                            ...
                                            <td ><?php echo $k['uid']; ?></a></td>
                                            <td><?php echo $k['order']; ?></td>
											<td class="am-hide-sm-only"><?php echo $k['type']; ?></td>
											<td class="am-hide-sm-only"><?php echo $k['money']; ?></td>
                                            <td class="am-hide-sm-only"><?php echo $k['addtime']; ?></td>
											<td class="am-hide-sm-only"><?php if($k['status'] == '1'): ?><button type="button" style="background-color: #5eb95e;pointer-events: none;" class="am-btn am-btn-success am-btn-xs">支付成功</button><?php else: ?><button type="button" style="background-color: #dd514c;pointer-events: none;" class="am-btn am-btn-danger am-btn-xs">未支付</button><?php endif; ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
